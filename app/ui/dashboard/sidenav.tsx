  ...
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      ...
      <div className="flex flex-col ">
        ...
        <Link className="flex flex-row grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-xs font-medium hover:bg-sky-100 hover:text-red-600 md:flex-none md:justify-start md:p-2 md:px-3" href="/logout">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
